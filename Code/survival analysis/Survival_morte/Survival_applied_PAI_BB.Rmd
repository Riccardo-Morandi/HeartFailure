...
data$days_of_followup <- as.numeric(data_BB$data_studio_out - data_BB$data_rif_ev)
data$PAI_RANGE <- cut(
  data$PAI,
...
survplots <- survfit(fit.all, newdata = modaldata)
{plot(survplots, xlab = "Days",ylab = "Survival Probability", col = 1:5, xlim = c(365,1095))
legend("bottomleft", legend = levels(PAI_RANGE), col = 1:5, lty = 1)}
```
